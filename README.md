...
Das ETL script zu bauen war nicht allzu schwierig, aber wir stiessen beim Cron-job auf eine Wand. Wir fanden keine richtige Dokumentation auf Moodle zum Cronjob-Tool. Dies machte es für uns sehr schwierig eine Lösung zu finden. Wir fanden keinen Weg, das config.php nicht in der Root zu haben. Das Task Scheduling Tool auf Infomaniak sahen wir dann als eine bessere Lösung, also benutzt unsere Webseite das. Trotzdem befassten wir uns mit der Funktion des Cronjobs, um es zu verstehen.
